...
+ (UIColor *)backgroundDarkColor {
    return self.class.backgroundDarkColor;
}
...
+ (UIColor *)backgroundElevation01LightColor {
    return self.class.backgroundElevation01LightColor;
}

+ (UIColor *)backgroundElevation02LightColor {
    return self.class.backgroundElevation02LightColor;
}

+ (UIColor *)backgroundElevation03LightColor {
    return self.class.backgroundElevation03LightColor;
}

+ (UIColor *)backgroundLightColor {
    return self.class.backgroundLightColor;
}

+ (UIColor *)backgroundSecondaryDarkColor {
    return self.class.backgroundSecondaryDarkColor;
}

+ (UIColor *)backgroundSecondaryLightColor {
    return self.class.backgroundSecondaryLightColor;
}

+ (UIColor *)backgroundTertiaryDarkColor {
    return self.class.backgroundTertiaryDarkColor;
}

+ (UIColor *)backgroundTertiaryLightColor {
    return self.class.backgroundTertiaryLightColor;
}
...
+ (UIColor *)systemGreen {
    return self.class.systemGreen;
}

+ (UIColor *)systemRed {
    return self.class.systemRed;
}
...
+ (UIColor *)lineDarkColor {
    return self.class.lineDarkColor;
}

+ (UIColor *)lineLightColor {
    return self.class.lineLightColor;
}

+ (UIColor *)primaryDarkColor {
    return self.class.primaryDarkColor;
}

+ (UIColor *)primaryLightColor {
    return self.class.primaryLightColor;
}

+ (UIColor *)shadowLgColor {
    return self.class.shadowLgColor;
}
...
+ (UIColor *)textPrimaryDarkColor {
    return self.class.textPrimaryDarkColor;
}

+ (UIColor *)textPrimaryLightColor {
    return self.class.textPrimaryLightColor;
}
...
+ (UIColor *)textSecondaryDarkColor {
    return self.class.textSecondaryDarkColor;
}

+ (UIColor *)textSecondaryLightColor {
    return self.class.textSecondaryLightColor;
}

+ (UIColor *)textTertiaryDarkColor {
    return self.class.textTertiaryDarkColor;
}

+ (UIColor *)textTertiaryLightColor {
    return self.class.textTertiaryLightColor;
}

+ (UIColor *)touchableOverlayColor {
    return self.class.touchableOverlayColor;
}
